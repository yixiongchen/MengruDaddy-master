...
public class followingUserAdapter extends BaseAdapter {
    ...
    public followingUserAdapter (Context context, String[] followingIds, User user){
        ...
        this.user = user;
        userIds = new String[this.followingIds.length];
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final String id = this.followingIds[position];
        ...
        if (convertView == null) {
            ...
            final followingUserAdapter.ViewHolder viewHolder = new followingUserAdapter.ViewHolder(imageView,username, follow,progressBar);
            convertView.setTag(viewHolder);
        }
        final followingUserAdapter.ViewHolder viewHolder = (followingUserAdapter.ViewHolder)convertView.getTag();

        //load likeId object
        //real time database
        database = FirebaseDatabase.getInstance();
        followingRef = database.getReference("users").child(id);
        ...
        followingRef.addListenerForSingleValueEvent(likeListener);
